###########################################################################
## Makefile generated for component 'RotaryInvertedPendulumHardwareInLoop'. 
## 
## Makefile     : RotaryInvertedPendulumHardwareInLoop.mk
## Generated on : Tue Dec 26 17:14:54 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/RotaryInvertedPendulumHardwareInLoop.elf
...
PRODUCT_NAME              = RotaryInvertedPendulumHardwareInLoop
MAKEFILE                  = RotaryInvertedPendulumHardwareInLoop.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/RotaryInvertedPendulumHardwareInLoop.elf
...
DEFINES_STANDARD = -DMODEL=RotaryInvertedPendulumHardwareInLoop -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_arduino_digitalio.o MW_PWM.o MW_PWMDriver.o ArduinoPinHandleMap.o encoder_arduino.o xcp_ext_mode.o RotaryInvertedPendulumHardwareInLoop.o RotaryInvertedPendulumHardwareInLoop_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_utils.o xcp_frame_serial.o xcp_ext_param_default_serial.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o platform_timer.o rtiostream_serial_daemon.o
...
%.o : $(START_DIR)/RotaryInvertedPendulumHardwareInLoop_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/RotaryInvertedPendulumHardwareInLoop_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/RotaryInvertedPendulumHardwareInLoop_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
RotaryInvertedPendulumHardwareInLoop.o : $(START_DIR)/RotaryInvertedPendulumHardwareInLoop_ert_rtw/RotaryInvertedPendulumHardwareInLoop.c
	$(CC) $(CFLAGS) -o "$@" "$<"


RotaryInvertedPendulumHardwareInLoop_data.o : $(START_DIR)/RotaryInvertedPendulumHardwareInLoop_ert_rtw/RotaryInvertedPendulumHardwareInLoop_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/RotaryInvertedPendulumHardwareInLoop_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/RotaryInvertedPendulumHardwareInLoop_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/RotaryInvertedPendulumHardwareInLoop_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/RotaryInvertedPendulumHardwareInLoop_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
