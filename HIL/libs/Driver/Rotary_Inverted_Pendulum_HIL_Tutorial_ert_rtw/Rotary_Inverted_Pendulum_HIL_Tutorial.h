...
#ifndef RTW_HEADER_Rotary_Inverted_Pendulum_HIL_Tutorial_h_
#define RTW_HEADER_Rotary_Inverted_Pendulum_HIL_Tutorial_h_
 ...
 * '<S2>'   : 'Rotary_Inverted_Pendulum_HIL_Tutorial/Subsystem1'
 * '<S3>'   : 'Rotary_Inverted_Pendulum_HIL_Tutorial/motor drive'
 * '<S4>'   : 'Rotary_Inverted_Pendulum_HIL_Tutorial/motor encoder'
 * '<S5>'   : 'Rotary_Inverted_Pendulum_HIL_Tutorial/pendulum encoder'
 * '<S6>'   : 'Rotary_Inverted_Pendulum_HIL_Tutorial/Subsystem1/waraper'
 * '<S7>'   : 'Rotary_Inverted_Pendulum_HIL_Tutorial/Subsystem1/waraper1'
 * '<S8>'   : 'Rotary_Inverted_Pendulum_HIL_Tutorial/motor encoder/Degrees to Radians'
 * '<S9>'   : 'Rotary_Inverted_Pendulum_HIL_Tutorial/pendulum encoder/Degrees to Radians'
 */
#endif                 /* RTW_HEADER_Rotary_Inverted_Pendulum_HIL_Tutorial_h_ */
