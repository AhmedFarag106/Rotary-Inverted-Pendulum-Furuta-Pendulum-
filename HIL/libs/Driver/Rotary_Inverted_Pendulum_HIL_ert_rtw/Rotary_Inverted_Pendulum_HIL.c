 ...
 *
 * File: Rotary_Inverted_Pendulum_HIL.c
 *
 * Code generated for Simulink model 'Rotary_Inverted_Pendulum_HIL'.
 *
 * Model version                  : 8.70
 * Simulink Coder version         : 23.2 (R2023b) 01-Aug-2023
 * C/C++ source code generated on : Wed Jan  3 15:18:03 2024
 *
...
#include "Rotary_Inverted_Pendulum_HIL.h"
#include "Rotary_Inverted_Pendulum_HIL_private.h"
#include <math.h>
#include "rtwtypes.h"
...
B_Rotary_Inverted_Pendulum_HI_T Rotary_Inverted_Pendulum_HIL_B;
...
/* Model step function */
void Rotary_Inverted_Pendulum_HIL_step(void)
{
  {
    real_T lastTime;
    ...
    if (Rotary_Inverted_Pendulum_HIL_DW.obj.SampleTime !=
        Rotary_Inverted_Pendulum_HIL_P.motorencoder_SampleTime_i) {
     ...
     *  MATLABSystem: '<S5>/motor encoder'
     */
    Rotary_Inverted_Pendulum_HIL_B.Gain1 =
      Rotary_Inverted_Pendulum_HIL_P.revtodegree_Gain * (real_T)
      rtb_motorencoder_0 * Rotary_Inverted_Pendulum_HIL_P.Gain1_Gain;

    /* Sum: '<S2>/Add' incorporates:
     *  Constant: '<S2>/Pi'
     */
    Rotary_Inverted_Pendulum_HIL_B.alpharegulated =
      Rotary_Inverted_Pendulum_HIL_B.Gain1 +
      Rotary_Inverted_Pendulum_HIL_P.Pi_Value;

    /* Switch: '<S7>/Switch' */
    if (Rotary_Inverted_Pendulum_HIL_B.alpharegulated >=
        Rotary_Inverted_Pendulum_HIL_P.Switch_Threshold) {
       ...
       *  Math: '<S7>/Rem'
       */
      Rotary_Inverted_Pendulum_HIL_B.Switch = rt_remd_snf
        (Rotary_Inverted_Pendulum_HIL_B.alpharegulated +
         Rotary_Inverted_Pendulum_HIL_P.Bias_Bias_m,
         Rotary_Inverted_Pendulum_HIL_P.Constant_Value_b) +
        Rotary_Inverted_Pendulum_HIL_P.Bias1_Bias_e;
    } else {
      /* Switch: '<S7>/Switch' incorporates:
       *  Bias: '<S7>/Bias2'
       *  Bias: '<S7>/Bias3'
      ...
      Rotary_Inverted_Pendulum_HIL_B.Switch = rt_remd_snf
        (Rotary_Inverted_Pendulum_HIL_B.alpharegulated +
         Rotary_Inverted_Pendulum_HIL_P.Bias2_Bias_j,
         Rotary_Inverted_Pendulum_HIL_P.Constant1_Value_p) +
        Rotary_Inverted_Pendulum_HIL_P.Bias3_Bias_i;
    }
    ...
    if (Rotary_Inverted_Pendulum_HIL_DW.obj_l.SampleTime !=
        Rotary_Inverted_Pendulum_HIL_P.motorencoder_SampleTime) {
     ...
     *  MATLABSystem: '<S4>/motor encoder'
     */
    Rotary_Inverted_Pendulum_HIL_B.revtodegree =
      Rotary_Inverted_Pendulum_HIL_P.revtodegree_Gain_j * (real_T)
      rtb_motorencoder_0;

    /* Gain: '<S8>/Gain1' */
    Rotary_Inverted_Pendulum_HIL_B.Gain1_l =
      Rotary_Inverted_Pendulum_HIL_P.Gain1_Gain_d *
      Rotary_Inverted_Pendulum_HIL_B.revtodegree;

    /* DataTypeConversion: '<S4>/Data Type Conversion3' */
    Rotary_Inverted_Pendulum_HIL_B.DataTypeConversion3 =
      Rotary_Inverted_Pendulum_HIL_B.Gain1_l;

    /* Switch: '<S6>/Switch' */
    if (Rotary_Inverted_Pendulum_HIL_B.DataTypeConversion3 >
        Rotary_Inverted_Pendulum_HIL_P.Switch_Threshold_c) {
       ...
       *  Math: '<S6>/Rem'
       */
      Rotary_Inverted_Pendulum_HIL_B.Switch_f = rt_remd_snf
        (Rotary_Inverted_Pendulum_HIL_B.DataTypeConversion3 +
         Rotary_Inverted_Pendulum_HIL_P.Bias_Bias,
         Rotary_Inverted_Pendulum_HIL_P.Constant_Value) +
        Rotary_Inverted_Pendulum_HIL_P.Bias1_Bias;
    } else {
      /* Switch: '<S6>/Switch' incorporates:
       *  Bias: '<S6>/Bias2'
       *  Bias: '<S6>/Bias3'
      ...
      Rotary_Inverted_Pendulum_HIL_B.Switch_f = rt_remd_snf
        (Rotary_Inverted_Pendulum_HIL_B.DataTypeConversion3 +
         Rotary_Inverted_Pendulum_HIL_P.Bias2_Bias,
         Rotary_Inverted_Pendulum_HIL_P.Constant1_Value) +
        Rotary_Inverted_Pendulum_HIL_P.Bias3_Bias;
    }
    ...
    if ((Rotary_Inverted_Pendulum_HIL_DW.TimeStampA >= rtb_Derivative_e) &&
      ...
      rtb_Derivative = (Rotary_Inverted_Pendulum_HIL_B.Gain1_l - *lastU) /
    ...
    if ((Rotary_Inverted_Pendulum_HIL_DW.TimeStampA_i >= rtb_Derivative_e) &&
      ...
      rtb_Derivative_e = (Rotary_Inverted_Pendulum_HIL_B.Gain1 - *lastU) /
        (rtb_Derivative_e - lastTime);
    }
     ...
     *  Abs: '<S1>/Abs'
     */
    if (fabs(Rotary_Inverted_Pendulum_HIL_B.Switch) >
        Rotary_Inverted_Pendulum_HIL_P.Linearitychecker_Threshold) {
      /* Switch: '<S1>/Linearity checker' incorporates:
       *  Constant: '<S1>/Constant'
       */
      Rotary_Inverted_Pendulum_HIL_B.ControlAction =
        Rotary_Inverted_Pendulum_HIL_P.Constant_Value_k;
    } else {
      /* Switch: '<S1>/Linearity checker' incorporates:
       *  Gain: '<S1>/Gain'
       *  Gain: '<S1>/Gain1'
       ...
       */
      Rotary_Inverted_Pendulum_HIL_B.ControlAction =
        (((-Rotary_Inverted_Pendulum_HIL_P.k[0] *
           Rotary_Inverted_Pendulum_HIL_B.Switch_f +
           -Rotary_Inverted_Pendulum_HIL_P.k[1] *
           Rotary_Inverted_Pendulum_HIL_B.Switch) +
          -Rotary_Inverted_Pendulum_HIL_P.k[2] * rtb_Derivative) +
         -Rotary_Inverted_Pendulum_HIL_P.k[3] * rtb_Derivative_e) *
        Rotary_Inverted_Pendulum_HIL_P.Gain_Gain;
    }

    /* End of Switch: '<S1>/Linearity checker' */

    /* Gain: '<S3>/Scaling' */
    rtb_Derivative = Rotary_Inverted_Pendulum_HIL_P.Scaling_Gain *
      Rotary_Inverted_Pendulum_HIL_B.ControlAction;

    /* Saturate: '<S3>/Saturation' */
    if (rtb_Derivative > Rotary_Inverted_Pendulum_HIL_P.Saturation_UpperSat) {
      rtb_Derivative = Rotary_Inverted_Pendulum_HIL_P.Saturation_UpperSat;
    } else if (rtb_Derivative <
               Rotary_Inverted_Pendulum_HIL_P.Saturation_LowerSat) {
      rtb_Derivative = Rotary_Inverted_Pendulum_HIL_P.Saturation_LowerSat;
    }
     ...
     */
    if (rtb_Derivative >= Rotary_Inverted_Pendulum_HIL_P.Switch1_Threshold) {
      rtb_Derivative_e = Rotary_Inverted_Pendulum_HIL_P.Constant_Value_a;
    } else {
      rtb_Derivative_e = Rotary_Inverted_Pendulum_HIL_P.Constant1_Value_e;
    }
    ...
    Rotary_Inverted_Pendulum_HIL_B.pwm = fabs(rtb_Derivative);
    ...
    if (Rotary_Inverted_Pendulum_HIL_B.pwm <= 255.0) {
      rtb_Derivative_e = Rotary_Inverted_Pendulum_HIL_B.pwm;
    } else {
...

  {
    ...
    *lastU = Rotary_Inverted_Pendulum_HIL_B.Gain1_l;
    ...
    *lastU = Rotary_Inverted_Pendulum_HIL_B.Gain1;
...
void Rotary_Inverted_Pendulum_HIL_initialize(void)
{
  /* Registration code */
  ...
  /* External mode info */
  Rotary_Inverted_Pendulum_HIL_M->Sizes.checksums[0] = (4235512667U);
  Rotary_Inverted_Pendulum_HIL_M->Sizes.checksums[1] = (1159473183U);
  Rotary_Inverted_Pendulum_HIL_M->Sizes.checksums[2] = (2058208656U);
  Rotary_Inverted_Pendulum_HIL_M->Sizes.checksums[3] = (2224418552U);
...
void Rotary_Inverted_Pendulum_HIL_terminate(void)
{
