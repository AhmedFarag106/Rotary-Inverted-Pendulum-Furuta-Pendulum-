 ...
 *
 * File: Rotary_Inverted_Pendulum_HIL_data.c
 *
...
P_Rotary_Inverted_Pendulum_HI_T Rotary_Inverted_Pendulum_HIL_P = {
  /* Variable: k
   * Referenced by: '<S1>/Gain1'
   */
  { -1.0000000755224185, 581702.2364904033, -23534.428895407615,
    44083.476448169618 },
