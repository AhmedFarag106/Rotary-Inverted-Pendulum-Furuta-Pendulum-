...
{
  {
     ...
     *  Constant: '<S2>/Pi'
     */
    Rotary_Inverted_Pendulum_HIL_B.Add = Rotary_Inverted_Pendulum_HIL_B.Gain1 +
      Rotary_Inverted_Pendulum_HIL_P.Pi_Value;

    /* Switch: '<S7>/Switch' */
    if (Rotary_Inverted_Pendulum_HIL_B.Add >=
      ...
      Rotary_Inverted_Pendulum_HIL_B.Switch = rt_remd_snf
        (Rotary_Inverted_Pendulum_HIL_B.Add +
...
void Rotary_Inverted_Pendulum_HIL_initialize(void)
{
  ...
  /* External mode info */
  Rotary_Inverted_Pendulum_HIL_M->Sizes.checksums[0] = (2100443753U);
  Rotary_Inverted_Pendulum_HIL_M->Sizes.checksums[1] = (2370743665U);
  Rotary_Inverted_Pendulum_HIL_M->Sizes.checksums[2] = (2870334849U);
  Rotary_Inverted_Pendulum_HIL_M->Sizes.checksums[3] = (1134144717U);
