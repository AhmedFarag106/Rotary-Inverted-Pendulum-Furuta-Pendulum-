###########################################################################
## Makefile generated for component 'Rotary_Inverted_Pendulum_HIL'. 
## 
## Makefile     : Rotary_Inverted_Pendulum_HIL.mk
## Generated on : Wed Jan 03 00:27:47 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Rotary_Inverted_Pendulum_HIL.elf
...
PRODUCT_NAME              = Rotary_Inverted_Pendulum_HIL
MAKEFILE                  = Rotary_Inverted_Pendulum_HIL.mk
MATLAB_ROOT               = F:/progs/matlab
MATLAB_BIN                = F:/progs/matlab/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = F:/ENG ASU/Senior 2/First Semester/Hybrid/Project/HIL
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Rotary_Inverted_Pendulum_HIL.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2023b_1/toolbox/target/SUPPOR~1/ARDUIN~2/include -I$(MATLAB_ROOT)/toolbox/target/shared/svd/common/include -IC:/Users/Ahmed/Desktop/libs/Driver/src -I$(START_DIR)/Rotary_Inverted_Pendulum_HIL_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/common -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/protocol/src -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/protocol/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/transport/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/transport/src -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/platform/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/platform/default -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/src -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src -I$(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino -I$(ARDUINO_ROOT)/hardware/arduino/avr/variants/mega -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2023b_1/toolbox/target/SUPPOR~1/ARDUIN~1/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2023b_1/toolbox/target/SUPPOR~1/ARDUIN~1/SCHEDU~1/include -I$(ARDUINO_ROOT)/hardware/tools/avr/avr/include/avr
...
DEFINES_STANDARD = -DMODEL=Rotary_Inverted_Pendulum_HIL -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_arduino_digitalio.o MW_PWM.o MW_PWMDriver.o ArduinoPinHandleMap.o encoder_arduino.o xcp_ext_mode.o Rotary_Inverted_Pendulum_HIL.o Rotary_Inverted_Pendulum_HIL_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_utils.o xcp_frame_serial.o xcp_ext_param_default_serial.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o platform_timer.o rtiostream_serial_daemon.o
...
%.o : $(START_DIR)/Rotary_Inverted_Pendulum_HIL_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/Rotary_Inverted_Pendulum_HIL_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Rotary_Inverted_Pendulum_HIL_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
encoder_arduino.o : C:/Users/Ahmed/Desktop/libs/Driver/src/encoder_arduino.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Rotary_Inverted_Pendulum_HIL.o : $(START_DIR)/Rotary_Inverted_Pendulum_HIL_ert_rtw/Rotary_Inverted_Pendulum_HIL.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Rotary_Inverted_Pendulum_HIL_data.o : $(START_DIR)/Rotary_Inverted_Pendulum_HIL_ert_rtw/Rotary_Inverted_Pendulum_HIL_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/Rotary_Inverted_Pendulum_HIL_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/Rotary_Inverted_Pendulum_HIL_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/Rotary_Inverted_Pendulum_HIL_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/Rotary_Inverted_Pendulum_HIL_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
